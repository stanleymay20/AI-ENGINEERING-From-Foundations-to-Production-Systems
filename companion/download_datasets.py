...
# Everything, including large datasets and framework benchmark archives
...
ALL_DOWNLOADABLE = set(UCI) | SKLEARN_BUILTIN | SKLEARN_FETCH | set(OFFICIAL_FILES)
...
def download(url: str, path: Path) -> None:
    ...
    req = urllib.request.Request(
        url, headers={"User-Agent": "AI-Engineering-Companion/3.23.8"}
    )
