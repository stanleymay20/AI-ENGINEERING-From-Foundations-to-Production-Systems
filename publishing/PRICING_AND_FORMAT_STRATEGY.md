...
1. **Paperback** — primary student/professional edition
2. **Hardcover** — library, institutional, lecturer, and premium-reference edition
3. **EPUB/Kindle** — searchable digital edition for code/reference use
...
- Hardcover cost: https://kdp.amazon.com/de_DE/help/topic/GHT976ZKSKUXBB6H
- Hardcover royalty: https://kdp.amazon.com/de_DE/help/topic/G77F3WPD3KQLJTFS
...
- US hardcover: **$69.99**
- US ebook: **$12.99**
- UK paperback: **£39.99–£42.99**
- UK hardcover: **£54.99–£59.99**
- UK ebook: **£9.99–£12.99**

## IngramSpark caution

Before locking global print prices, model the actual IngramSpark print cost, wholesale discount, returnability policy, and channel compensation. A price that works for KDP can be uneconomic for broad trade distribution.

## Final price gate

No price is locked until all of the following are complete:

- final publisher/imprint decision;
- final format-specific ISBN assignment;
- final print ink/paper/binding choice;
- current KDP print-cost and royalty calculation;
- current IngramSpark print-cost/wholesale simulation;
- German price-compliance check where applicable;
- retailer setup validation;
